class DisappearedsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @disappeared.save
        format.html { redirect_to relative_disappeared_path(@relative, @disappeared), notice: t('.success') }
  ...
  def update
    respond_to do |format|
      if @disappeared.update(disappeared_params)
        format.html { redirect_to relative_disappeared_path(@relative, @disappeared), notice: t('.updated' ) }
  ...
  def destroy
    @disappeared.destroy
    respond_to do |format|
      format.html { redirect_to relative_disappeareds_path(@relative), notice: t('.destroyed')}
