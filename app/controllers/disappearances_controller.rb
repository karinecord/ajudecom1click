...
class DisappearancesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @disappearance.save
        format.html { redirect_to relative_disappeared_disappearances_path(@relative, @disappeared), notice: t('.success') }
  ...
  def update
    respond_to do |format|
      if @disappearance.update(disappearance_params)
        format.html { redirect_to relative_disappeared_disappearances_path(@relative, @disappeared), notice: t('.updated' ) }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to relative_disappeared_disappearances_path(@relative, @disappeared), notice: t('.destroyed') }
  ...
  def set_disappeared
    ...
    def disappearance_params
      params.require(:disappearance).permit(:date, :hour, :disappeareds_id, :email, :password, :notification_face, :number_police_report, :police_station, :disappearance_history)
    end
end
