class RelativesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @relative.save
        format.html { redirect_to @relative, notice: t('.success') }
  ...
  def update
    respond_to do |format|
      if @relative.update(relative_params)
        format.html { redirect_to @relative, notice: t('.updated' ) }
  ...
  def destroy
    @relative.destroy
    respond_to do |format|
      format.html { redirect_to relatives_url, notice: t('.destroyed')}
