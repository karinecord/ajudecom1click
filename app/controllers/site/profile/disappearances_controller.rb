require 'mail'
class  Site::Profile::DisappearancesController  < Site::ProfileController
  ...
  def create
    ...
    @disappearance.created_by = current_member

    respond_to do |format|
      if @disappearance.save
        format.html { redirect_to new_site_profile_relative_disappeared_disappearance_path(@relative,@disappeared), notice: t('.success') }
  ...
  def update
    respond_to do |format|
      if @disappearance.update(disappearance_params)
        format.html { redirect_to site_profile_relative_disappeared_disappearances_path(@relative, @disappeared), notice: t('.updated' ) }
